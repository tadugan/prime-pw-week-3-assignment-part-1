...
let favoriteFoods = ['steak', 'pizza', 'hamburgers', 'sushi', 'pasta'];
...
// This line was missing a semicolon at the end, so I added one.
...
console.log('The last animal is still', animalArray[animalArray.length - 1]);
